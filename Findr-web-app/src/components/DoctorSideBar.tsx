      ...
      <Sidebar className="border-r bg-white">
        ...
        <SidebarHeader className="h-14 border-b px-4 py-2">
          <div className="flex items-center gap-3">
            ...
            <Link to="">
              <span className="text-xl font-bold tracking-wide">Doctor</span>
            </Link>
          </div>
        </SidebarHeader>
        ...
        <SidebarFooter className="h-14 border-b px-4 py-2 ">
          <div
            onClick={logout}
            className="flex items-center gap-3 w-full cursor-pointer hover:text-rose-500"
          >
            <LogOut className="h-6 w-6 text-primary" />
            <span className="text-lg font-bold tracking-wide">Logout</span>
          </div>
        </SidebarFooter>
      </Sidebar>
    </SidebarProvider>
