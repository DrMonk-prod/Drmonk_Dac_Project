...
import com.finddr.service.DoctorScheduleServiceImpl;
...
public class SlotController {
    private final DoctorScheduleServiceImpl scheduleService;
    ...
    public ResponseEntity<DoctorScheduleDto> getSchedulesByDoctorAndDay(@PathVariable Long doctorId,
